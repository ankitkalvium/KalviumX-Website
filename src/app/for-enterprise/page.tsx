        ...
        <div className="container-x grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="mt-7 flex flex-wrap gap-4">
              <Button href="/start-a-pilot">Book a briefing</Button>
            ...
            {companySizes.map((size, i) => (
              <Reveal key={size.tag} delay={i * 80}>
                <div className={`rounded-2xl p-8 h-full flex flex-col ${size.accent ? "bg-ink text-white" : "bg-white border border-line"}`}>
                  <span className="inline-block text-[11px] font-extrabold uppercase tracking-[0.14em] text-red mb-4">
                    {size.tag}
                  </span>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex items-center justify-center py-8 lg:py-0">
              ...
              >
                <defs>
                  {/*
                    Lines trimmed to circle edges:
                    Center r=58 at (240,150). Nodes r=38 at corners.
                    Direction unit vectors (all same magnitude ~194.1):
                    TL: (-0.886, -0.464)  TR: (0.886, -0.464)
                    BL: (-0.886,  0.464)  BR: (0.886,  0.464)
                    Center exit = center ± 62*unit (slight gap past r=58)
                    Node entry  = node  ∓ 42*unit (slight gap past r=38)
                  */}
                ...
                {/* Connection lines — trimmed between circle edges */}
                ...
                {/* Traveling dots — one per line, steady pace */}
                ...
                {/* Stakeholder nodes — drawn after lines so they sit on top */}
